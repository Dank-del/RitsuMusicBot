...
func LoadHandlers(d *ext.Dispatcher) {
	...
	linkSpotifyCmd := handlers.NewCommand(linkSpotifyCommand, linkSpotifyHandler)
	...
	d.AddHandler(handlers.NewCommand(unlinkSpotifyCommand, unlinkSpotifyHandler))
